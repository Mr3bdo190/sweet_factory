  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _searchQuery.isEmpty
          ? const Center(
              child: Text('اكتب اسم للبحث 🔍', style: TextStyle(color: Colors.grey, fontSize: 18)),
            )
          : StreamBuilder<QuerySnapshot>(
              // بحث ذكي في الفايربيز بالاسم
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return const Center(child: Text('مفيش حد بالاسم ده', style: TextStyle(color: Colors.grey)));
                }
